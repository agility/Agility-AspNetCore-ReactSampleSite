            ...
            <div className="col-md-4">
                <div className="featurer-item">
                    <div className="item-inner">
                        ...
                        <a className="arrow-button" href={this.props.item.button.href} target={this.props.item.button.target}><span>{this.props.item.button.text}</span><img src="https://static.agilitycms.com/layout/img/ico/gray.svg" alt=""/></a>
                    </div>
                </div>
            </div>
        );
